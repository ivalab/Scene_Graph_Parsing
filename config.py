...
#GT_IMAGES = '/home/ruinian/IVALab/Project/TaskGrounding/AI2THOR_DATA_GENERATION/data/vg_format/Image'
#IM_DATA_FN_GT = '/home/ruinian/IVALab/Project/TaskGrounding/AI2THOR_DATA_GENERATION/data/vg_format/image_data.json'
#GT_SGG_FN = '/home/ruinian/IVALab/Project/TaskGrounding/AI2THOR_DATA_GENERATION/data/vg_format/GT-SGG.h5'
#GT_SGG_DICT_FN = '/home/ruinian/IVALab/Project/TaskGrounding/AI2THOR_DATA_GENERATION/data/vg_format/dict.json'
#PROPOSAL_FN_GT = '/home/ruinian/IVALab/Project/TaskGrounding/AI2THOR_DATA_GENERATION/data/vg_format/proposals.h5'

GT_IMAGES = './data/sgp/Image'
IM_DATA_FN_GT = './data/sgp/image_data.json'
GT_SGG_FN = './data/sgp/GT-SGG.h5'
GT_SGG_DICT_FN = './data/sgp/dict.json'
PROPOSAL_FN_GT = './data/sgp/proposals.h5'
# =============================================================================
# =============================================================================
...
BOX_SCALE_GT = 512  # Scale at which we have the boxes
IM_SCALE_GT = 512      # Our images will be resized to this res without padding
...
class ModelConfig(object):
    ...
    def __init__(self):
        ...
        if self.model not in ('rtnet', 'motifnet', 'stanford'):
