...
from config import IM_SCALE, IM_SCALE_GT, RPN_NEGATIVE_OVERLAP, RPN_POSITIVE_OVERLAP, \
...
def anchor_target_layer(gt_boxes, im_size, allowed_border=0, dataset='vg'):
    """
    ...
    """
    assert dataset in ['vg', 'gt']
    if dataset == 'vg':
        im_scale = IM_SCALE
    elif dataset == 'gt':
        im_scale = IM_SCALE_GT
